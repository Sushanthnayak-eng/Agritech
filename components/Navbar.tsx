...
const Navbar: React.FC<NavbarProps> = ({ activeTab, setActiveTab, currentUser }) => {
  const navItems = [
        ...
        <div className="flex items-center gap-1 md:gap-8">
          {navItems.map((item) => (
            <button
              ...
              className={`flex flex-col items-center justify-center h-14 px-2 border-b-2 transition-colors ${
                activeTab === item.id ? 'border-agri-green text-agri-green' : 'border-transparent text-slate-500 hover:text-slate-900'
              }`}
            >
          ...
          <button 
            ...
            className={`flex flex-col items-center justify-center h-14 px-2 border-b-2 transition-colors ${
              activeTab === 'profile' ? 'border-agri-green text-agri-green' : 'border-transparent text-slate-500 hover:text-slate-900'
            }`}
          >
